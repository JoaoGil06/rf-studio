...
const documents: Documents = {
    ...
    "\n  mutation RegisterSchedule($input: RegisterScheduleInput!) {\n    registerSchedule(input: $input) {\n      __typename\n      ... on RegisterScheduleSuccess {\n        schedule {\n          id\n          date\n          status\n          finalPrice\n          service {\n            id\n            durationMinutes\n          }\n          ...ReservationEntryFields\n        }\n      }\n      ... on UserNotFoundError {\n        message\n      }\n      ... on ServiceNotFoundError {\n        message\n      }\n      ... on ScheduleAlreadyBookedError {\n        message\n      }\n    }\n  }\n": types.RegisterScheduleDocument,
    "\n  fragment ProductCardFields on Product {\n    id\n    name\n    brand\n    category\n    color\n    isAvailable\n  }\n": types.ProductCardFieldsFragmentDoc,
    "\n  fragment ReservationEntryFields on Schedule {\n    id\n    date\n    status\n    user {\n      id\n      name\n    }\n    service {\n      id\n      name\n      category\n    }\n  }\n": types.ReservationEntryFieldsFragmentDoc,
    "\n  fragment ReservationRowFields on Schedule {\n    id\n    date\n    status\n    finalPrice\n    user {\n      id\n      name\n    }\n    service {\n      id\n      name\n      category\n    }\n  }\n": types.ReservationRowFieldsFragmentDoc,
    "\n  fragment ReservationStatusFields on Schedule {\n    id\n    status\n    date\n    user {\n      id\n      name\n    }\n  }\n": types.ReservationStatusFieldsFragmentDoc,
    "\n  mutation UpdateReservationStatus($input: UpdateScheduleInput!) {\n    updateSchedule(input: $input) {\n      __typename\n      ... on UpdateScheduleSuccess {\n        schedule {\n          id\n          status\n        }\n      }\n      ... on ScheduleNotFoundError {\n        message\n      }\n      ... on ServiceNotFoundError {\n        message\n      }\n      ... on ScheduleAlreadyBookedError {\n        message\n      }\n    }\n  }\n": types.UpdateReservationStatusDocument,
    "\n  fragment ServiceCardFields on Service {\n    id\n    name\n    category\n    price\n    durationMinutes\n  }\n": types.ServiceCardFieldsFragmentDoc,
    "\n  query Users($first: Int, $after: String, $role: RoleName) {\n    users(first: $first, after: $after, role: $role) {\n      edges {\n        cursor\n        node {\n          id\n        }\n      }\n      pageInfo {\n        hasNextPage\n        endCursor\n      }\n    }\n  }\n": types.UsersDocument,
    "\n  query SchedulesCachePolicy($first: Int, $after: String, $filter: SchedulesFilter) {\n    schedules(first: $first, after: $after, filter: $filter) {\n      edges {\n        cursor\n        node {\n          id\n        }\n      }\n      pageInfo {\n        hasNextPage\n        endCursor\n      }\n    }\n  }\n": types.SchedulesCachePolicyDocument,
    "\n  query Ping {\n    users(first: 1) {\n      pageInfo {\n        hasNextPage\n      }\n    }\n  }\n": types.PingDocument,
